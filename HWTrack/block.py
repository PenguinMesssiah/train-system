...
class Block(object):
    ...
    def __init__(self, number):
        ...
        self.crossing = dict()
        self.lights = dict()
        self.occupancy_ctc = dict({number: 0})
        self.commanded_speed = dict({number: 0})
        self.authority = dict({number: 0})
...
#        return self.switch
    ...
    def setSwitchPosition(self, position):
        self.switch.update({number: position})
        print(self.switch)
...
#            return self.crossing
    ...
    def setCrossingState(self, state):
        self.crossing.update({number: state})
...
#            return True
    ...
    def addLight(self):
		self.lights.update({number: [0, 0, 0, 0]})
		print(self.lights)

	def setSuperGreenLight(self):
		self.lights.update({number: [0, 0, 0, 1]})
		print(self.lights)

	def setGreenLight(self):
		self.lights.update({number: [0, 0, 1, 0]})
		print(self.lights)

	def setYellowLight(self):
		self.lights.update({number: [0, 1, 0, 0]})
		print(self.lights)

	def setRedLight(self):
		self.lights.update({number: [1, 0, 0, 0]})
		print(self.lights)
