...
class Connections(QObject):
    ...
    train_model_receive_beacon = pyqtSignal(int, float)
    train_model_send_commandedSpeed_ctrl = pyqtSignal(int, float)
    train_model_send_lights_ctrl = pyqtSignal(int, bool)
    train_model_send_commandedSpeed_ctrl = pyqtSignal(int, float)

    train_model_send_brakeFailure_ctrl = pyqtSignal(int, bool)
    train_model_send_engineFailure_ctrl = pyqtSignal(int, bool)
    train_model_send_signalPickupFailure_ctrl = pyqtSignal(int, bool)
    train_model_send_velocity_ctrl = pyqtSignal(int, bool)
    train_model_send_gps_ctrl = pyqtSignal(int, float)
