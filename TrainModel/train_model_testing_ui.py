...
class Testing_UI(object):
    def setupUi(self, Test, currentTrainNum):
        ...
        self.test_grid.addWidget(self.setPower_text, 12, 1, 1, 1)
        ...
        self.toggleDoors_button = QtWidgets.QPushButton(Test)
        self.toggleDoors_button.setObjectName("toggleDoors_button")
        self.test_grid.addWidget(self.toggleDoors_button, 12, 0, 1, 1)
        ...
        self.stop_button = QtWidgets.QPushButton(Test)
        self.stop_button.setObjectName("stop_button")
        self.gridLayout_4.addWidget(self.setValues_button, 1, 1, 1, 1)
        self.gridLayout_4.addWidget(self.stop_button, 1, 5, 2, 1)
        ...
        self.test_grid.addLayout(self.gridLayout_4, 12, 2, 1, 1)
        ...
        self.stop_button.pressed.connect(self.stopRun)
